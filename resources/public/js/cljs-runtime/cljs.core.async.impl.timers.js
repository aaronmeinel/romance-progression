...
var i_37034 = (self__.level + (1));
while(true){
if((i_37034 <= (new_level + (1)))){
(update[i_37034] = self__.header);

var G__37035 = (i_37034 + (1));
i_37034 = G__37035;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_37037 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_37037[i]));
} else {
x__$2.forward.push((((i < links_37037.length))?(links_37037[i]):null));
}

if((i < links_37037.length)){
(links_37037[i] = x__$2);
} else {
links_37037.push(x__$2);
}
...
var i_37045 = (0);
while(true){
if((i_37045 <= self__.level)){
var links_37046 = (update[i_37045]).forward;
if((x__$1 === (((i_37045 < links_37046.length))?(links_37046[i_37045]):null))){
(links_37046[i_37045] = (x__$1.forward[i_37045]));

var G__37048 = (i_37045 + (1));
i_37045 = G__37048;
continue;
} else {
var G__37052 = (i_37045 + (1));
i_37045 = G__37052;
continue;
}
} else {
...
var G__37059 = nx;
var G__37060 = (level__$1 - (1));
x = G__37059;
level__$1 = G__37060;
continue;
} else {
var G__37061 = x;
var G__37062 = (level__$1 - (1));
x = G__37061;
level__$1 = G__37062;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__37066 = nx;
var G__37067 = (level__$1 - (1));
x = G__37066;
level__$1 = G__37067;
continue;
} else {
var G__37068 = x;
var G__37069 = (level__$1 - (1));
x = G__37068;
level__$1 = G__37069;
continue;
}
