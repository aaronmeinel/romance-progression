...
if((!((next_attr == null)))){
var G__46844 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__46844;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__46747){
var map__46748 = p__46747;
var map__46748__$1 = cljs.core.__destructure_map(map__46748);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46748__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
var freeze_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46748__$1,new cljs.core.Keyword(null,"freeze-kw","freeze-kw",391758233),datascript.serialize.freeze_kw);
...
var e = d.e;
var a = (function (){var G__46768 = d.a;
return (attrs_map.cljs$core$IFn$_invoke$arity$1 ? attrs_map.cljs$core$IFn$_invoke$arity$1(G__46768) : attrs_map.call(null, G__46768));
})();
var v = write_v(d.v);
...
var schema = (function (){var G__46773 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__46773) : freeze_fn.call(null, G__46773));
})();
...
(datascript.serialize.from_serializable.cljs$core$IFn$_invoke$arity$2 = (function (from,p__46814){
var map__46815 = p__46814;
var map__46815__$1 = cljs.core.__destructure_map(map__46815);
var opts = map__46815__$1;
var thaw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46815__$1,new cljs.core.Keyword(null,"thaw-fn","thaw-fn",-240544261),clojure.edn.read_string);
var thaw_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__46815__$1,new cljs.core.Keyword(null,"thaw-kw","thaw-kw",1076733097),datascript.serialize.thaw_kw);
var tx0 = datascript.serialize.dict_get(from,"tx0");
var schema = (function (){var G__46819 = datascript.serialize.dict_get(from,"schema");
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__46819) : thaw_fn.call(null, G__46819));
})();
var _ = (function (){var fexpr__46821 = new cljs.core.Var(function(){return datascript.db.validate_schema;},new cljs.core.Symbol("datascript.db","validate-schema","datascript.db/validate-schema",-783030261,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"datascript.db","datascript.db",-444456104,null),new cljs.core.Symbol(null,"validate-schema","validate-schema",758884380,null),"datascript/db.cljc",23,1,928,928,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"schema","schema",58529736,null)], null)),null,(cljs.core.truth_(datascript.db.validate_schema)?datascript.db.validate_schema.cljs$lang$test:null)]));
return (fexpr__46821.cljs$core$IFn$_invoke$arity$1 ? fexpr__46821.cljs$core$IFn$_invoke$arity$1(schema) : fexpr__46821.call(null, schema));
})();
...
var pred__46828 = cljs.core._EQ__EQ_;
var expr__46829 = marker;
if(cljs.core.truth_((pred__46828.cljs$core$IFn$_invoke$arity$2 ? pred__46828.cljs$core$IFn$_invoke$arity$2((0),expr__46829) : pred__46828.call(null, (0),expr__46829)))){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(keywords,datascript.serialize.array_get(v,(1)));
} else {
if(cljs.core.truth_((pred__46828.cljs$core$IFn$_invoke$arity$2 ? pred__46828.cljs$core$IFn$_invoke$arity$2((1),expr__46829) : pred__46828.call(null, (1),expr__46829)))){
var G__46831 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__46831) : thaw_fn.call(null, G__46831));
} else {
if(cljs.core.truth_((pred__46828.cljs$core$IFn$_invoke$arity$2 ? pred__46828.cljs$core$IFn$_invoke$arity$2((2),expr__46829) : pred__46828.call(null, (2),expr__46829)))){
return Infinity;
} else {
if(cljs.core.truth_((pred__46828.cljs$core$IFn$_invoke$arity$2 ? pred__46828.cljs$core$IFn$_invoke$arity$2((3),expr__46829) : pred__46828.call(null, (3),expr__46829)))){
return -Infinity;
} else {
if(cljs.core.truth_((pred__46828.cljs$core$IFn$_invoke$arity$2 ? pred__46828.cljs$core$IFn$_invoke$arity$2((4),expr__46829) : pred__46828.call(null, (4),expr__46829)))){
return NaN;
} else {
...
var aevt = (function (){var G__46832 = datascript.serialize.dict_get(from,"aevt");
if((G__46832 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__46806_SHARP_){
return (eavt[p1__46806_SHARP_]);
}),G__46832);
}
})();
var avet = (function (){var G__46833 = datascript.serialize.dict_get(from,"avet");
if((G__46833 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__46808_SHARP_){
return (eavt[p1__46808_SHARP_]);
}),G__46833);
}
})();
var settings = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"branching-factor","branching-factor",1903198601),datascript.serialize.dict_get(from,"branching-factor"),new cljs.core.Keyword(null,"ref-type","ref-type",-1367328851),(function (){var G__46834 = datascript.serialize.dict_get(from,"ref-type");
if((G__46834 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__46834);
}
