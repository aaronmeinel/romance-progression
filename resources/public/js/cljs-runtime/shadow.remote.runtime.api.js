...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32766 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32766(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_32773 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_32773(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_32778 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_32778(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_32781 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_32781(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32790 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32790(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32803 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32803(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__32755,callback){
var map__32756 = p__32755;
var map__32756__$1 = cljs.core.__destructure_map(map__32756);
var input = map__32756__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32756__$1,new cljs.core.Keyword(null,"code","code",1586293142));
