...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_32821 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_32821(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_32829 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_32829(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_32836 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_32836(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_32840 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_32840(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_32844 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_32844(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_32894 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_32894(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_32898 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_32898(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_32900 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_32900(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_32902 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_32902(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_32906 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_32906(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32914 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32914(b);
}
});
