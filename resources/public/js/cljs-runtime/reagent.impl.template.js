...
var G__39244 = o;
reagent.impl.template.goog$module$goog$object.set(G__39244,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__39629__i < G__39629__a.length) {G__39629__a[G__39629__i] = arguments[G__39629__i + 0]; ++G__39629__i;}
  args = new cljs.core.IndexedSeq(G__39629__a,0,null);
} 
...
var args = cljs.core.seq(arglist__39630);
...
var G__39273 = o;
reagent.impl.template.goog$module$goog$object.set(G__39273,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__39633.cljs$lang$applyTo = (function (arglist__39645){
var args = cljs.core.seq(arglist__39645);
...
var G__39287 = props;
var G__39287__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39287,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39287);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39287__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39295 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39295,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39295;
}
})(),id_class);
...
var G__39311 = (cljs.core.count(argv) - first_child);
switch (G__39311) {
case (0):
...
var vec__39396 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39396,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39396,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39396,(2),null);
...
var temp__5827__auto___39708 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___39708 == null)){
} else {
var key_39709 = temp__5827__auto___39708;
(jsprops.key = key_39709);
}
...
var temp__5827__auto___39711 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___39711 == null)){
} else {
var key_39712 = temp__5827__auto___39711;
(jsprops.key = key_39712);
}
...
var temp__5827__auto___39718 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___39718 == null)){
} else {
var key_39719 = temp__5827__auto___39718;
(jsprops.key = key_39719);
}
...
var temp__5827__auto___39745 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___39745 == null)){
} else {
var key_39746 = temp__5827__auto___39745;
(jsprops.key = key_39746);
}
...
var temp__5827__auto___39750 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___39750 == null)){
} else {
var key_39751 = temp__5827__auto___39750;
(jsprops.key = key_39751);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39515_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39515_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39535 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39535,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39535,(1),null);
...
break;
default:
var G__39762 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39763 = compiler;
v = G__39762;
compiler = G__39763;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template39577 = (function (opts,id,fn_to_element,parse_fn,meta39578){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39577.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39579,meta39578__$1){
var self__ = this;
var _39579__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39577(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta39578__$1));
}));

(reagent.impl.template.t_reagent$impl$template39577.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39579){
var self__ = this;
var _39579__$1 = this;
return self__.meta39578;
}));

(reagent.impl.template.t_reagent$impl$template39577.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39577.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39577.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template39577.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39577.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39577.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta39578","meta39578",1868852280,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39577.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39577.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39577");

(reagent.impl.template.t_reagent$impl$template39577.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template39577");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39577.
 */
reagent.impl.template.__GT_t_reagent$impl$template39577 = (function reagent$impl$template$__GT_t_reagent$impl$template39577(opts,id,fn_to_element,parse_fn,meta39578){
return (new reagent.impl.template.t_reagent$impl$template39577(opts,id,fn_to_element,parse_fn,meta39578));
});
...
return (new reagent.impl.template.t_reagent$impl$template39577(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
