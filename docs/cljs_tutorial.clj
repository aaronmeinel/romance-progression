...
;;
;; ### Start shadow-cljs (in terminal):
;; ```bash
;; npx shadow-cljs watch app
;; ```
;;
;; ### Connect your editor:
;; 1. shadow-cljs starts nREPL on port 7889
;; 2. In VS Code/Calva: "Connect to running REPL" → select shadow-cljs
;; 3. Select the `:app` build
;;
;; Now you can eval ClojureScript forms and see results in the browser!
...
^{:kind :code}
(comment
  ;; Clojure (Java)              | ClojureScript (JavaScript)
  ;; ----------------------------|----------------------------
  ;; (.method obj arg)           | (.method obj arg)
  ;; (.-field obj)               | (.-field obj)  
...
;; - [DataScript docs](https://github.com/tonsky/datascript)
